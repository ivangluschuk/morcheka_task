...
const mapDispatchToProps = dispatch => ({
	appActions: {
		...
		toCrudPage: function(mode) {
			dispatch(appActions.toCrudPage.call(this, mode));
		},
	},
	registerActions: {
		register: function(login, password) {
			dispatch(registerActions.register.call(this, login, password));
		},
		onFieldChange: function(field, event) {
			dispatch(registerActions.onFieldChange.call(this, field, event));
		},
	},
	loginActions: {
		onFieldChange: function(field, event) {
			dispatch(loginActions.onFieldChange.call(this, field, event));
		},
		login: function(login, password) {
			dispatch(loginActions.login.call(this, login, password));
		},
	},
});
